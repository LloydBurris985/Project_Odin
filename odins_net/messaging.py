...
def read_board(user: UserState, eye: OdinsEye, board_name: str):
    ...
    while True:
         ...
         print("\nCommands:")
         print("  R # to reply (e.g. R 1)")
         print("  N next page / P previous page")
         print("  poll to poll board")
         print("  Q to quit board")

         sub_cmd = input("Enter command (R #, N, P, poll, Q): ").strip().lower()
         ...
         if sub_cmd in ["n", "next"]:
             ...
             try:
                 ...
                 # Reply chaining code here (your existing code)
                 print("Reply sent – refresh board to see")
             except:
             ...
             print("Invalid command. Use R #, N, P, poll, Q")
...
""")
                 ...
                 # Your polished compose code here (text + video chunk simulation)
                 print("Compose / Post")
                 # ... your existing compose logic ...
                 input("Press Enter...")
                 ...
                 # Your full S block here
                 input("Press Enter...")

             elif choice.upper() == "U":
                 # Your full U block here
                 input("Press Enter...")
