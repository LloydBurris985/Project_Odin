...
class Runway:
    ...
    def __init__(
        ...
        name: Optional[str] = None,                   # ← added here (Path B)
        base: int = 10,
        limit: int = 4,
        low: int = 20000,
        high: int = 39999,
        ...
        Args:
            ...
            name: Optional human-readable name for this runway instance
        ...
        """
        self.name = name or "Unnamed Runway"           # ← stored here
        self.base = base
        self.limit = limit
        self.low = low
        self.high = high
    ...
    def advance(self, bit: int = 0) -> int:
        ...
        # Bound wrapping + sign flip (using end_mask)
